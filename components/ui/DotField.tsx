...
export default DotField;import { useEffect, useRef, memo } from 'react';
...
const DotField = memo(({
  ...
  // To avoid hydration errors, we can just use a constant or don't render gradients immediately on SSR.
  // Using a stable ID for SSR/Hydration
  const glowId = "dot-field-glow";
