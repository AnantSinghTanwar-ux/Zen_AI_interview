        ...
        <div className="mx-auto px-6 max-w-7xl w-full">
          ...
          <section className="glass-card p-10 md:p-12 mb-24 overflow-hidden relative">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
              ...
              <div className="flex-1 flex justify-center items-center h-[260px]">
                {/* Visual abstract placeholder for the previous robot image to fit cinematic theme */}
          ...
          <section className="flex flex-col gap-12 mt-12 pb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="glass-card p-10 h-full flex flex-col group hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
              ...
              <div className="glass-card p-10 h-full flex flex-col group hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#49de50]/10 blur-[50px] group-hover:bg-[#49de50]/20 transition-all rounded-full pointer-events-none"></div>
                  <div className="w-14 h-14 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center mb-8 relative z-10">
